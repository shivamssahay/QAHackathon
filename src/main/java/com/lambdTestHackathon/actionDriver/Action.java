package com.lambdTestHackathon.actionDriver;
...
import com.lambdaTestHackathon.actionInterface.ActionInterface;
...
//		driver.switchTo().alert().wait();
	...
	public void promptAlert(WebDriver driver, String prompt)  {
//		driver.switchTo().alert().wait();
